...
EXEC Tree.CtCategoryInsert @CategoryId = 104, @Name = N'Accessories', @AncestorId = 103;
EXEC Tree.CtCategoryInsert @CategoryId = 105, @Name = N'Cleaning', @AncestorId = 103;
EXEC Tree.CtCategoryInsert @CategoryId = 106, @Name = N'Linens', @AncestorId = 103;
GO
...
EXEC Tree.CtCategoryInsert @CategoryId = 112, @Name = N'Appliances', @AncestorId = 111;
...
EXEC Tree.CtCategoryInsert @CategoryId = 116, @Name = N'Utensils', @AncestorId = 111;
GO
...
EXEC Tree.CtCategoryInsert @CategoryId = 119, @Name = N'Furniture', @AncestorId = 191;
...
EXEC Tree.CtCategoryInsert @CategoryId = 123, @Name = N'Cycling', @AncestorId = 122;
...
EXEC Tree.CtCategoryInsert @CategoryId = 131, @Name = N'Football', @AncestorId = 128;
